...
type RequestServiceClient interface {
	AddRequest(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Request, error)
}
...
func (c *requestServiceClient) AddRequest(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Request, error) {
	out := new(Request)
	err := c.cc.Invoke(ctx, "/pipelines.RequestService/AddRequest", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRequestServiceServer) AddRequest(context.Context, *Request) (*Request, error) {
...
func _RequestService_AddRequest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RequestServiceServer).AddRequest(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pipelines.RequestService/AddRequest",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RequestServiceServer).AddRequest(ctx, req.(*Request))
	}
...
var RequestService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pipelines.RequestService",
	HandlerType: (*RequestServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "AddRequest",
			Handler:    _RequestService_AddRequest_Handler,
		},
	},
